...
-- Admin-editable commission rate per physician, applied by
-- category_merger.py when writing commission_per_physicians rows.
CREATE TABLE IF NOT EXISTS physician_commission_rates (
    physician_id       INTEGER PRIMARY KEY REFERENCES physicians(physician_id),
